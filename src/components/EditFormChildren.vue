<template>
    <div class="flex justify-center max-w-3xl mx-auto py-10">
        <div class="w-full h-full ">
            <form class="bg-[#15393C] rounded px-12 pt-8 pb-8 mb-8" v-bind:action="'https://localhost:7777/api/childupdate/' + child.id" method="post">
                <div class="flex mb-4">
                    <img :src="child.photo" class="rounded-lg h-48 w-52" alt="Avatar" />
                    <div class="px-4">
                        <label class="block text-white text-sm font-bold" for="image">
                            ...
                            <input
                                ...
                                id="name" type="text" placeholder="Nome do Animal" name="childname" v-model="child.name">
                            <label class="block text-white text-sm font-bold mb-2" for="username">
                            Sexo do Animal
                        </label>
                ...
                <div class="flex justify-start"> 
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="age" type="text" placeholder="Idade" name="childage" v-model="child.age">
                        </div>
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-black-900 leading-tight focus:outline-none focus:shadow-outline"
                        id="desc" type="text" placeholder="Descrição" name="childdesc" v-model="child.description">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="name" type="text" placeholder="Observações" name="childobs" v-model="child.observations">
                </div>
