        ...
        <div class="w-full h-full ">
                ...
                <div class="flex justify-center">
                        <div>
                            ...
                            <a href="/adminn/escolas" class="bg-white text-[#15393C] font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" value="Cancelar">Cancelar</a>    
