...
export async function addChild(
  ...
  childstate: string,
  childcpf: string,
  childmaterialsneeded: string,
  childresponsables: string
) {
...
export async function addDonation(
  donationdonatortype: string,
  donationdonator: string,
  donationemail: string,
  donationcpf: string,
  donationcnpj: string,
  donationcellphone: string,
  donationtype: string,
  donationvalue: string,
  donationmaterials: string,
  donationdonatedto: string,
  donationdonatedtoid: string,
