...
function getChild(child_id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!child) {
            prisma.$disconnect();
            return new responseConstructor_1.response(503, `Child ${child_id} not found!`);
        }
        yield prisma.$disconnect();
        return new responseConstructor_1.response(200, `Child ${child_id} found!`, child);
    });
}
...
function getSchool(school_id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!school) {
            prisma.$disconnect();
            return new responseConstructor_1.response(503, `School ${school_id} not found!`);
        }
        yield prisma.$disconnect();
        return new responseConstructor_1.response(200, `School ${school_id} found!`, school);
    });
}
...
function getDonations() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.$disconnect();
        return new responseConstructor_1.response(200, "Donations found", donations);
    });
}
...
function getDonation(donation_id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!donation) {
            prisma.$disconnect();
            return new responseConstructor_1.response(503, `Donation ${donation_id} not found!`);
        }
        yield prisma.$disconnect();
        return new responseConstructor_1.response(200, `Donation ${donation_id} found!`, donation);
    });
}
...
function getState(state_id) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!state) {
            prisma.$disconnect();
            return new responseConstructor_1.response(503, `Child ${state_id} not found!`);
        }
        yield prisma.$disconnect();
        return new responseConstructor_1.response(200, `Child ${state_id} found!`, state);
    });
}
